...
use day_25::{read_data, Input, PART_1, PART_2};
...
fn bench() {
    ...
    let mut group = criterion.benchmark_group("Day 25");
    ...
    group.bench_with_input("part 1", &input, |b, i| {
        b.iter(|| assert_eq!(PART_1.clone(), i.part_1()))
    });
    ...
    group.bench_with_input("total", &contents, |b, i| {
        b.iter(|| {
            ...
            assert_eq!(PART_1.clone(), data.part_1());
